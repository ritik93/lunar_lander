...
This iterative method converges to the optimal action-value function $Q(s,a)\approx Q^*(s,a)$ as ***i -> ∞***. This means that the agent just needs to gradually explore the state-action space and keep updating the estimate of $Q(s,a)\approx Q^*(s,a)$ until it converges to the optimal action-value function $Q(s,a)\approx Q^*(s,a)$. However, in cases where the state space is continuous it becomes practically impossible to explore the entire state-action space. Consequently, this also makes it practically impossible to gradually estimate $ Q(s,a) $ until it converges to $Q^*(s,a)$.
